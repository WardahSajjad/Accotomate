...
const Testimonials = () => {
  return (
    <section className="dark:bg-green-900 bg-green-50 relative z-10 py-16 md:py-20 lg:py-28">
      <div className="container">
        <SectionTitle
          title="What Our Clients Say"
          paragraph="Discover how Accotomate has helped businesses streamline financial processes, stay compliant, and achieve peace of mind."
          center
        />
